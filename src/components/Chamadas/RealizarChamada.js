  ...
  useEffect(() => {
    const fetchTurmas = async () => {
      try {
        ...
        console.log('Turmas encontradas:', turmasData); // Log para verificar os dados retornados
  ...
  useEffect(() => {
    ...
    const fetchAlunos = async () => {
      try {
        ...
        console.log('Alunos encontrados:', alunosData); // Log para verificar os alunos retornados
